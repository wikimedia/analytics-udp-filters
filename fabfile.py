...
def write_control_file(version):
	...
	fh.write('Build-Depends: debhelper (>= 7.0.50~), libgeoip-dev, libgeoip1 (>= 1.4.6)\n')
	...
	#fh.write('Architecture: x86_64-linux-gnu\n')
	#fh.write('Version: %s\n' % version)	
	#fh.write('Depends: debhelper (>= 7.0.50~), autotools-dev, mime-support, mawk, libc6 (>= 2.4)\n')
